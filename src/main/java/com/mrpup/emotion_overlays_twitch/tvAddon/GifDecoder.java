...
import com.mrpup.emotion_overlays.animate.AnimatedTexture;
...
public class GifDecoder {
    ...
    public static AnimatedTexture decode(byte[] gifBytes) throws IOException {
        ...
        BufferedImage canvas = new java.awt.image.BufferedImage(
                width, height, BufferedImage.TYPE_INT_ARGB);
        BufferedImage previousCanvas = new java.awt.image.BufferedImage(
                width, height, BufferedImage.TYPE_INT_ARGB);
